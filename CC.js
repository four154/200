$.getScript("https://raw.githack.com/waleed-qaid/des3/main/%E2%80%8F%E2%80%8F1des.net-mdrdsh.com%20-%20rooms.js");
...
var me_user1 = setInterval(function () {
  if (myid != null) {
    ...
    $("#users .uzr:contains('عدن')").addClass("stl1");
    $("#users .uzr.stl1 .c-flex.fr").append('<img class="My_star1" src="https://up6.cc/2024/10/172946129714632.gif">');
    $("#users .uzr.stl1 .c-flex.fr").append('<img class="My_tsor" src="https://i.ibb.co/ThKHx1N/image.png">');
    $("#users .uzr.stl1 .c-flex.fr").after('<div id="my_mood1" class="label label-primary" style=" margin-bottom: 1px; display: inline-block;width: 100%;margin-top: 10px;height: 22px;cursor: pointer;border-radius: 50px;padding: 0px;background-image: linear-gradient(-225deg, #000 0%, #000 29%, #1376bb 67%, #000 100%);" href="https://www.shm0.net/">للطلب التواصل واتس آب</div>');
    $("#users .uzr.stl1 span.u-topic").after('<img id="mystory1" class="My_vedio1" title="ستوري" style="float: right;width: 20px;margin-top: 0px;margin-right: 5px;cursor: pointer;" src="https://up6.cc/2024/10/172946129656751.gif">');
    ...
    $("div#users .uzr:contains('عدن') .My_vedio1").click(function () {
      $("#movon1").show();
      ...
      $("#movon1").append('<iframe id="ifr_mov1" style="max-width: 340px;min-width: 300px;right: 0; top: 35px; left: auto;" class="modal in" role="dialog" style="z-index: 2100; display: none; style="max-width:240px;" src="https://www.youtube.com/watch?v=v4M5jBUZecQ" allowfullscreen="" width="338" height="490" frameborder="0"></iframe>');
...
var l_itvaiah = setInterval(function () {
  if (myid != null) {
    ...
    $("#users .uzr:contains('ساندي')").addClass("aiah1");
    $("#users .uzr.aiah1 .fitimg.u-pic").append('<img class="aiah_star1" src="https://up6.cc/2023/02/167579486894821.png">');
    $("#users .uzr.aiah1 .c-flex.fr").after('<div id="my_mood1" class="label label-primary" style=" margin-bottom: 1px; display: inline-block;width: 100%;margin-top: 10px;height: 22px;cursor: pointer;border-radius: 50px;padding: 0px;background-image: linear-gradient(-225deg, #000 0%, #000 29%, #1376bb 67%, #000 100%);" href="https://www.shm0.net/">للطلب التواصل واتس اب</div>');
    $("#users .uzr.aiah1 span.u-topic").after('<img id="mystory1" class="My_vedio1" title="ستوري" style="float: right;width: 20px;margin-top: 0px;margin-right: 5px;cursor: pointer;" src="https://up6.cc/2024/10/172946129656751.gif">');
